...
public class MyProcessAllWindowFunction extends ProcessAllWindowFunction<Integer, Tuple2<String,Integer>, TimeWindow> {
    ...
    public void process(Context context, Iterable<Integer> elements, Collector<Tuple2<String,Integer>> out) throws Exception {
        ...
        out.collect(Tuple2.of(start_timestamp+" ~ "+end_timestamp,sum));
